...
const HtmlPreview: React.FC<HtmlPreviewProps> = ({ onBack }) => {
  // 状态管理
    ...
    <div className="flex flex-col h-screen bg-gray-950 text-white">
      ...
      <header className="h-16 bg-gray-900 border-b border-gray-800 flex items-center justify-between px-4 lg:px-6 shadow-md z-10">
        ...
        <div 
          ...
          title="返回目录"
        >
          <div className="w-8 h-8 bg-gradient-to-br from-blue-500 to-indigo-600 rounded-lg flex items-center justify-center shadow-lg shadow-blue-500/20 group-hover:scale-105 transition-transform">
          ...
          <h1 className="text-lg font-bold tracking-tight text-gray-100 hidden sm:block group-hover:text-white transition-colors">
            HTML <span className="text-gray-400 font-normal group-hover:text-gray-300">在线预览</span>
          </h1>
        </div>
